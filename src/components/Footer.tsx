        ...
        <div className="grid grid-cols-2 gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="col-span-2 sm:col-span-1 lg:col-span-3">
            <ul className="flex flex-col gap-3">
              <h5 className="text-defaul-200 mb-2 font-medium lg:text-lg xl:text-xl">
                About Us
              </h5>
                ...
                <form onSubmit={handleSubmit} className="text-base text-white">
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="bg-default-950/60 pe-40 ps-40 h-12 w-full rounded-lg border-white/10 py-4 text-white backdrop-blur-3xl focus:border-white/10 focus:ring-0"
                    />
                    <button
                      type="submit"
                    ...
                    [<TiSocialFacebook/>,
                      ...
                      <li key={index}> 
                          <a href="#" className="hover:bg-primary group inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 transition-all duration-500">
                            <i className="text-default-300 group-hover:text-white"> {social}</i>
                          </a>
                      </li>
                    ))
                  }
