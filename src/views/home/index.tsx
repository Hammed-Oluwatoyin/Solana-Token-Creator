...
const HomeView = ({setOpenCreateModal}) => {
  return (
                ...
                <div className="container">
                    <div className="p-6">
                        <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                            <div
                                className="bg-primary/20 -z-1 start-0 absolute top-0 h-14 w-14 animate-[spin_10s_linear_infinite] rounded-2xl rounded-br-none rounded-tl-none">

                            </div>
                            <div
                                className="bg-primary/20 -z-1 end-0 absolute bottom-0 h-14 w-14 animate-ping rounded-full">
                            ...
                            <span
                                ...
                                <div className={"new_add_css"}>
                                    ...
                                    }} className="hover:bg-primary-hover pe-4 group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-1 py-1 text-white transition-all duration-500">
                            ...
                            <div className="mx-auto h-[595px] overflow-hidden">
                                <div className="marquee grid grid-cols-2 gap-6">
                                    ...
                                    <div className="marquee-reverse relative m-auto flex flex-col gap-6 overflow-hidden">
                                        <div
                                            className={" marquee-hero m-auto flex min-h-full flex-shrink-0 flex-col items-center justify-around gap-6"}>
