              ...
              <div className={"mb-10 flex items-end justify-between"}>
                <div className={"mx-auto max-w-2xl text-center"}>
                  ...
                  <p className={"text-default-200 text-sm font-medium"}>
                    Solana allows users to create and manage tokens using the Solana Program Library (SPL). SPL tokens are versatile and can represent fungible (like currencies) or non-fungible assets (like NFTs).
                    With its speed, low fees, and developer tools, Solana simplifies token creation and management for various use cases like payments, rewards, and digital collectibles.
                  </p>
                </div>
              </div>
                    ...
                    <div className={"bg-default-950/40 rounded-xl backdrop-blur-3xl"} onClick={() => tool.function(true)}>
                      <div className="p-6">
                        ...
                        <a className={"text-primary group relative inline-flex items-center gap-2"}>
                          ...
                          Select & try  <i data-lucide={"move-right"}>
